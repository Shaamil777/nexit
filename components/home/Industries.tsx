            ...
            <div className="w-full max-w-[1500px] mx-auto relative z-10 pt-10 overflow-x-auto md:overflow-x-visible snap-x snap-mandatory md:snap-none pb-6 md:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                <div className="flex items-end gap-4 md:gap-6 w-max px-4 md:px-0 md:pl-16 lg:pl-32">
                    ...
                    <motion.div 
                        ...
                        className="w-[150px] md:w-[180px] h-[210px] md:h-[240px] relative shrink-0 ml-0 md:ml-[-300px] snap-center transition-transform duration-200 hover:-translate-y-3 cursor-pointer"
                    >
                        <Image
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="absolute bottom-0 left-0 bg-gradient-to-r from-[#049E9F] to-black text-white px-3 py-1.5 md:px-4 md:py-2 w-[90%] md:w-[85%] text-[11px] md:text-base font-medium"
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true, margin: "-50px" }}
                        className="w-[150px] md:w-[180px] h-[210px] md:h-[240px] relative shrink-0 snap-center transition-transform duration-200 hover:-translate-y-3 cursor-pointer"
                    >
                        <Image
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true, margin: "-50px" }}
                        className="w-[150px] md:w-[320px] h-[210px] md:h-[440px] relative shrink-0 snap-center transition-transform duration-200 hover:-translate-y-3 cursor-pointer"
                    >
                        <Image
